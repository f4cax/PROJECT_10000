...
export const translations = {
  ru: {
    ...
    startWithIndexFunds: 'Начните с индексных фондов',
    investRegularly: 'Инвестируйте регулярно',
    diversifyBySectors: 'Диверсифицируйте по секторам',
    dontPanicShortTerm: 'Не паникуйте при краткосрочных падениях',
    studyFinancialLiteracy: 'Изучайте финансовую грамотность',
    importantWarnings: 'Важные предупреждения',
    pastPerformanceWarning: 'Прошлая доходность не гарантирует будущих результатов',
    investOnlyAffordableMoney: 'Инвестируйте только те деньги, которые можете позволить себе потерять',
    highReturnHighRisk: 'Высокая доходность = высокий риск',
    considerFinancialAdvisor: 'Рассмотрите консультацию с финансовым консультантом',
    studyTaxAspects: 'Изучите налоговые аспекты',
